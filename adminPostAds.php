                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <div class="col-sm-5 well well-sm" style="min-height: 200px; max-height: 200px; overflow-y:scroll; margin: 10px;">
                                <a href=<?php echo "actions/adsModeration.php?type=post_ad&status=2&product_id=".$row['product_id']; ?> class="btn btn-danger pull-right">
                ...
                <div role="tabpanel" class="tab-pane" id="rejected">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) { ?>
                            <div class="col-sm-5 well well-sm" style="min-height: 200px; max-height: 200px; overflow-y:scroll; margin: 10px;">
                                <a href=<?php echo "actions/adsModeration.php?type=post_ad&status=1&product_id=".$row['product_id']; ?> class="btn btn-success pull-right" style='margin-right: 1%'>
