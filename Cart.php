...
<body>
	...
	<br>
        ...
        ?>
            <a href='products.php' class="btn btn-success btn-lg pull-right">
                <span  aria-hidden="true"></span>&nbsp;
                Continue Shopping
            </a>
        
        <?php }else { ?>
			<a href='Login.php' class="btn btn-success btn-lg pull-right">
                <span  aria-hidden="true"></span>&nbsp;
                Continue Shopping
            </a>
        <?php } ?>
        ...
        <form action="<?php echo $paypalURL; ?>" method="post">
            ...
            <div class="row  col-md-offset-1">
                ...
                $totalCost = 0;
                $sql = "SELECT C.cart_id, P.* FROM cart C JOIN products P ON C.product_id = P.product_id where P.status = 1 AND C.paid = 0 AND C.user_id=".$userId;
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <div class="col-sm-5 well well-sm" style="min-height: 200px; max-height: 200px; overflow-y:scroll; margin: 10px;">
                            ...
                            <!-- Specify URLs -->
                            <input type='hidden' name='cancel_return' value='http://www.mumarket.us/Cart.php'>
                ...
                <span class="col-md-offset-1">
                    ...
                    <?php }else{ ?>
                        <a href="http://www.mumarket.us/products.php" id="btn-block">Please add producs to cart</a>
                    <?php }?>
                </span><br/><br/>
            </form>
        </div>
